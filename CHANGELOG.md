...
**2023.06.30：** We trained a speech emotion recognition model from [here](https://github.com/liuhaozhe6788/TIM-Net_SER) and further trained the synthesizer, so that the system can now capture the emotion feature from the reference audio, making it possible for emotion voice cloning. 
